# Adapted from gyyang23/GCNet under MIT. See vendor/GCNet/LICENSE.
# Network topology and block fusion retained. Framework primitives replaced by gc_compat.
import math
import numpy as np
import torch
...
from .gc_compat import ConvModule, build_norm_layer, build_activation_layer, BaseModule, DAPPM, resize
_BatchNormXd = nn.BatchNorm2d
